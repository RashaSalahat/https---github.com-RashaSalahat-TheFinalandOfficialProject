...
import 'package:hotel_booking/screens/chat_screen.dart';
import 'package:hotel_booking/themechat.dart';
import 'package:hotel_booking/helpers.dart';
import 'package:hotel_booking/models/models_chat.dart';
...
class MessagesPage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return  CustomScrollView(
      slivers: [const SliverToBoxAdapter(child: _Stories(),
      ),
...
class _MessageTile extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return InkWell(
      onTap: (){
         Navigator.of(context).push(ChatScreeen.route(messageData));
      },
