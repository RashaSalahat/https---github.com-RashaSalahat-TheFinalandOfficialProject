...
class PharmApp extends StatefulWidget {
  const PharmApp({Key? key}) : super(key: key);

  @override
  _PharmAppState createState() => _PharmAppState();
}

class _PharmAppState extends State<PharmApp> with TickerProviderStateMixin {
