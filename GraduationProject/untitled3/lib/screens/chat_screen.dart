...
import 'package:hotel_booking/models/message_data.dart';
import 'package:hotel_booking/widgets/icon_buttons.dart';
import '../helpers.dart';
import '../themechat.dart';
import '../widgets/avatarchat.dart';
...
class ChatScreeen extends StatelessWidget{
  ...
  const  ChatScreeen  ({Key?key,required this.messageData}):super(key:key);
  ...
  Widget build(BuildContext context){
    return  Scaffold(
        ...
        body:Column(children:const [ Expanded( child: _DemoMessageList()),_ActionBar()]));
  }
}
...
class _DemoMessageList extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    ...
    children: const[
      ...
      _MessageTile(message: "Hi lucy!",messageDate: '12.01',),
...
class _ActionBar extends StatelessWidget{
 ...
 bottom: true,
    ...
    icon: Icons.send_rounded, onPressed: () {  },
